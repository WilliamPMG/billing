 ...
 * @author DELL G7
 */
@Schema(name = "InvoiceResponse", description = "Modelo para realziar el response")
@Data
public class InvoiceResponse {
    @Schema(name = "invoiceId", requiredMode = Schema.RequiredMode.REQUIRED, example = "2", defaultValue = "1", description = "Clave Unica para representar al jefe y llamada")
